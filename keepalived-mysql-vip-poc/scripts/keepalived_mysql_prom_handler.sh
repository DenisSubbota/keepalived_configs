...
# state (MASTER/FAULT). Labels: cluster, vip (IP address). Metric value 0=healthy, 1=failover_error.
#
# Usage:
#   With flags:  /path/to/script --state MASTER --vip 192.168.88.18 [--cluster NAME]
#
# Options:
